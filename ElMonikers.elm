...
reshuffle model = case model.cards of
    (_, _, _, done) -> let (l, s) = Shuffle.rShuffle 3 (done, model.nextSeed)
                        in ((length l, [], l, []), s)
...
dummyCards =
  toCards
    [
      ( "Genre 1", "Category 1", "Title 1", "Description 1" )
    , ( "Genre 2", "Category 2", "Title 2", "Description 2" )
    , ( "Genre 3", "Category 3", "Title 3", "Description 3" )
    , ( "Genre 4", "Category 4", "Title 4", "Description 4" )
    , ( "Genre 5", "Category 5", "Title 5", "Description 5" )
